<?php
/*
Plugin Name: iframe v2
Plugin URI: https://github.com/alexfurr/iframe-v2
Description: Forked version of iframe plugin to enable fullscreen [iframe src="http://www.youtube.com/embed/oDlbBy9vfgI" width="100%" height="500"] shortcode
Version: 4.5
Author: webvitaly
...
function iframe_plugin_add_shortcode_cb( $atts ) {
	...
	foreach( $atts as $attr => $value ) {
		...
		// if the value is an int then set it as true
		if (is_numeric($attr) )
		{
			$html .= ' ' . esc_attr( $value ).'="true"';
